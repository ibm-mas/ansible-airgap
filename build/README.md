...
```
cd docs/roles
ROLE=case_install; ln -s ../../ibm/mas_devops/roles/$ROLE/README.md $ROLE.md
...
ROLE=case_mirror; ln -s ../../ibm/mas_devops/roles/$ROLE/README.md $ROLE.md
...
ROLE=case_prepare; ln -s ../../ibm/mas_devops/roles/$ROLE/README.md $ROLE.md
